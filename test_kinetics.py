...
# alias module since pickle looks for old module structure
sys.modules['westpa.binning'] = westpa.core.binning
...
class TestKinetics:
    def setUp(self):
        ...
        assign_config = {
            ...
            "output": os.path.join(self.path, "{}.h5".format("assign")),
            "states_from_file": "odld/STATES",
            "bins_from_file": "odld/BINS",
        }
        args = []
        for key, value in assign_config.items():
